...
new Modification()
    {
        OriginalItem = ModAPI.FindSpawnable("Bulletproof Sheet"),
        NameOverride = AMTag + "Kick-Ass Costume", 
        NameToOrderByOverride = "KA",
        DescriptionOverride = "Kick-Ass Costume", 
        CategoryOverride = ModAPI.FindCategory("Kick-Ass"),
        ThumbnailOverride = ModAPI.LoadSprite("Armor/Kick-Ass/Thumb.png"),
        AfterSpawn = (Instance) => 
        {
            Instance.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("Armor/Kick-Ass/Armor/Mask.png");
            Instance.GetComponent<PhysicalBehaviour>().HoldingPositions = new Vector3[0];
            Instance.GetComponent<PhysicalBehaviour>().InitialMass = 0.01f;
            Instance.GetComponent<PhysicalBehaviour>().TrueInitialMass = 0.01f;
            ...
            prop.scaleOffset = new Vector3(0f, 0f);
            prop.offset = new Vector3(0f, 0f);
            prop.sprite = "Armor/Kick-Ass/Armor/Mask.png";
            armor.stabResistance = 15f;

            armProp[0].armorPiece = "UpperBody";
            armProp[0].armorTier = 4;
            armProp[0].scaleOffset = new Vector3(0f, 0f);
            armProp[0].offset = new Vector3(0f, 0f);
            armProp[0].sprite = "Armor/Kick-Ass/Armor/UpperBody.png";
     

            armProp[1].armorPiece = "MiddleBody";
            armProp[1].armorTier = 4;
            armProp[1].scaleOffset = new Vector3(0f, 0f);
            armProp[1].offset = new Vector3(0f, 0f);
            armProp[1].sprite = "Armor/Kick-Ass/Armor/MiddleBody.png";

            armProp[2].armorPiece = "LowerBody";
            armProp[2].armorTier = 4;
            armProp[2].scaleOffset = new Vector3(0f, 0f);
            armProp[2].offset = new Vector3(0.0f, 0f);
            armProp[2].sprite = "Armor/Kick-Ass/Armor/LowerBody.png";

            armProp[3].armorPiece = "UpperArm";
            armProp[3].armorTier = 4;
            armProp[3].scaleOffset = new Vector3(0f, 0f);
            armProp[3].offset = new Vector3(0f, 0f);
            armProp[3].sprite = "Armor/Kick-Ass/Armor/UpperArm.png";

            armProp[4].armorPiece = "LowerArm";
            armProp[4].armorTier = 4;
            armProp[4].scaleOffset = new Vector3(0f, 0f);
            armProp[4].offset = new Vector3(0f, -0f);
            armProp[4].sprite = "Armor/Kick-Ass/Armor/LowerArm.png";

            armProp[5].armorPiece = "UpperLeg";
            armProp[5].armorTier = 4;
            armProp[5].scaleOffset = new Vector3(0f, 0f);
            armProp[5].offset = new Vector3(0f, 0f);
            armProp[5].sprite = "Armor/Kick-Ass/Armor/UpperLeg.png";

            armProp[6].armorPiece = "LowerLeg";
            armProp[6].armorTier = 4;
            armProp[6].scaleOffset = new Vector3(0f, 0f);
            armProp[6].offset = new Vector3(0f, 0f);
            armProp[6].sprite = "Armor/Kick-Ass/Armor/LowerLeg.png";

            armProp[7].armorPiece = "UpperArmFront";
            armProp[7].armorTier = 4;
            armProp[7].scaleOffset = new Vector3(.08f, .08f);
            armProp[7].offset = new Vector3(0f, 0f);
            armProp[7].sprite = "Armor/Kick-Ass/Armor/UpperArm.png";
   
            armProp[8].armorPiece = "UpperLegFront";
            armProp[8].armorTier = 4;
            armProp[8].scaleOffset = new Vector3(0f, 0f);
            armProp[8].offset = new Vector3(0f, 0f);
            armProp[8].sprite = "Armor/Kick-Ass/Armor/UpperLeg.png";

            armProp[9].armorPiece = "LowerLegFront";
            armProp[9].armorTier = 4;
            armProp[9].scaleOffset = new Vector3(0f, 0f);
            armProp[9].offset = new Vector3(0f, 0f);
            armProp[9].sprite = "Armor/Kick-Ass/Armor/LowerLeg.png";

            armProp[10].armorPiece = "Foot";
            armProp[10].armorTier = 4;
            armProp[10].scaleOffset = new Vector3(0f, 0f);
            armProp[10].offset = new Vector3(0f, 0f);
            armProp[10].sprite = "Armor/Kick-Ass/Armor/Foot.png";

            armProp[11].armorPiece = "FootFront";
            armProp[11].armorTier = 4;
            armProp[11].scaleOffset = new Vector3(0f, 0f);
            armProp[11].offset = new Vector3(0f, 0f);
            armProp[11].sprite = "Armor/Kick-Ass/Armor/Foot.png";

            armProp[12].armorPiece = "LowerArmFront";
            armProp[12].armorTier = 4;
            armProp[12].scaleOffset = new Vector3(0f, 0f);
            armProp[12].offset = new Vector3(0f, 0f);
            armProp[12].sprite = "Armor/Kick-Ass/Armor/LowerArm.png";
...
new Modification()
    {
        OriginalItem = ModAPI.FindSpawnable("Bulletproof Sheet"),
        NameOverride = AMTag + "Misc Costume", 
        NameToOrderByOverride = "KA",
        DescriptionOverride = "Misc Costume", 
        CategoryOverride = ModAPI.FindCategory("Kick-Ass"),
        ThumbnailOverride = ModAPI.LoadSprite("Armor/Misc/Thumb.png"),
        AfterSpawn = (Instance) => 
        {
            Instance.GetComponent<SpriteRenderer>().sprite = ModAPI.LoadSprite("Armor/Misc/Armor/Mask.png");
            Instance.GetComponent<PhysicalBehaviour>().HoldingPositions = new Vector3[0];
            Instance.GetComponent<PhysicalBehaviour>().InitialMass = 0.01f;
            Instance.GetComponent<PhysicalBehaviour>().TrueInitialMass = 0.01f;
            ...
            prop.scaleOffset = new Vector3(0f, 0f);
            prop.offset = new Vector3(0f, 0f);
            prop.sprite = "Armor/Misc/Armor/Mask.png";
            armor.stabResistance = 15f;
            ...
            armProp[0].scaleOffset = new Vector3(0f, 0f);
            armProp[0].offset = new Vector3(0f, 0f);
            armProp[0].sprite = "Armor/Misc/Armor/UpperBody.png";
            ...
            armProp[1].scaleOffset = new Vector3(0f, 0f);
            armProp[1].offset = new Vector3(0f, 0f);
            armProp[1].sprite = "Armor/Misc/Armor/MiddleBody.png";

            armProp[2].armorPiece = "LowerBody";
            armProp[2].armorTier = 5;
            armProp[2].scaleOffset = new Vector3(0f, 0f);
            armProp[2].offset = new Vector3(0.0f, 0f);
            armProp[2].sprite = "Armor/Misc/Armor/LowerBody.png";

            armProp[3].armorPiece = "UpperArm";
            armProp[3].armorTier = 5;
            armProp[3].scaleOffset = new Vector3(0f, 0f);
            armProp[3].offset = new Vector3(0f, 0f);
            armProp[3].sprite = "Armor/Misc/Armor/UpperArm.png";

            armProp[4].armorPiece = "LowerArm";
            armProp[4].armorTier = 5;
            armProp[4].scaleOffset = new Vector3(0f, 0f);
            armProp[4].offset = new Vector3(0f, -0f);
            armProp[4].sprite = "Armor/Misc/Armor/LowerArm.png";

            armProp[5].armorPiece = "UpperLeg";
            armProp[5].armorTier = 5;
            armProp[5].scaleOffset = new Vector3(0f, 0f);
            armProp[5].offset = new Vector3(0f, 0f);
            armProp[5].sprite = "Armor/Misc/Armor/UpperLeg.png";

            armProp[6].armorPiece = "LowerLeg";
            armProp[6].armorTier = 5;
            armProp[6].scaleOffset = new Vector3(0f, 0f);
            armProp[6].offset = new Vector3(0f, 0f);
            armProp[6].sprite = "Armor/Misc/Armor/LowerLeg.png";

            armProp[7].armorPiece = "UpperArmFront";
            armProp[7].armorTier = 5;
            armProp[7].scaleOffset = new Vector3(.08f, .08f);
            armProp[7].offset = new Vector3(0f, 0f);
            armProp[7].sprite = "Armor/Misc/Armor/UpperArm.png";
   
            armProp[8].armorPiece = "UpperLegFront";
            armProp[8].armorTier = 5;
            armProp[8].scaleOffset = new Vector3(0f, 0f);
            armProp[8].offset = new Vector3(0f, 0f);
            armProp[8].sprite = "Armor/Misc/Armor/UpperLeg.png";

            armProp[9].armorPiece = "LowerLegFront";
            armProp[9].armorTier = 5;
            armProp[9].scaleOffset = new Vector3(0f, 0f);
            armProp[9].offset = new Vector3(0f, 0f);
            armProp[9].sprite = "Armor/Misc/Armor/LowerLeg.png";

            armProp[10].armorPiece = "Foot";
            armProp[10].armorTier = 5;
            armProp[10].scaleOffset = new Vector3(0f, 0f);
            armProp[10].offset = new Vector3(0f, 0f);
            armProp[10].sprite = "Armor/Misc/Armor/Foot.png";

            armProp[11].armorPiece = "FootFront";
            armProp[11].armorTier = 5;
            armProp[11].scaleOffset = new Vector3(0f, 0f);
            armProp[11].offset = new Vector3(0f, 0f);
            armProp[11].sprite = "Armor/Misc/Armor/Foot.png";

            armProp[12].armorPiece = "LowerArmFront";
            armProp[12].armorTier = 5;
            armProp[12].scaleOffset = new Vector3(0f, 0f);
            armProp[12].offset = new Vector3(0f, 0f);
            armProp[12].sprite = "Armor/Misc/Armor/LowerArm.png";
